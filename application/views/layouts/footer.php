            ...
            <div class="row">
                <div class="col-lg-6">
                    <ul class="list-inline mb-0">
                        <li class="list-inline-item"><a href="<?= base_url('assets') ?>backend/privacy-policy.html">Privacy Policy</a></li>
                        <li class="list-inline-item"><a href="<?= base_url('assets') ?>backend/terms-of-service.html">Terms of Use</a></li>
                    </ul>
                </div>
